  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center px-6 py-16">
      <div className="mb-10 max-w-xl text-center">
        <p className="mb-3 text-sm tracking-[0.2em] text-muted-foreground uppercase">Converge</p>
        <h1 className="text-4xl font-semibold tracking-tight text-balance sm:text-5xl">
          Find your hackathon team
        </h1>
        <p className="mt-4 text-base text-muted-foreground text-pretty">
          Join an event with a code, meet people looking for teammates, and find each other on the
          map day-of.
        </p>
      </div>
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>Skeleton shell — Auth0 and live events come next.</CardDescription>
        </CardHeader>
